...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], FoodItem.prototype, "protein", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], FoodItem.prototype, "carbs", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], FoodItem.prototype, "fat", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: false }),
    __metadata("design:type", Boolean)
], FoodItem.prototype, "isCustom", void 0);
exports.FoodItem = FoodItem = __decorate([
    (0, mongoose_1.Schema)({ timestamps: { createdAt: true, updatedAt: false } })
], FoodItem);
exports.FoodItemSchema = mongoose_1.SchemaFactory.createForClass(FoodItem);
